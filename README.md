...
**Institutional Commercial Real Estate & REIT Data Warehouse: Net Operating Income (NOI), WAULT lease expiry risk, Cap Rate vs discount rate sensitivity, and tenant rollover.**

[![CI Analytics Pipeline](https://github.com/abdussatarkhan/PropPulse-Commercial-RealEstate-Asset-Analytics/actions/workflows/ci.yml/badge.svg)](https://github.com/abdussatarkhan/PropPulse-Commercial-RealEstate-Asset-Analytics/actions)
...
[![Maintenance](https://img.shields.io/badge/Maintained%3F-yes-brightgreen.svg?style=flat-square)](https://github.com/abdussatarkhan/PropPulse-Commercial-RealEstate-Asset-Analytics)
...
**PropPulse-Commercial-RealEstate-Asset-Analytics** is an enterprise-grade analytics data warehouse and business intelligence platform built for **Commercial Real Estate & REIT Analytics**.
...
### 1️⃣ Executive KPI Command Center (Executive Architectural Slate (Cool Light))
...
```
                    ...
                    └────────────┬────────────┘
                                 ...
                                 ▼
┌──────────────────────┐   ┌─────────────────────────┐   ┌─────────────────────────┐
│     dim_properties_asset │──►│     fact_lease_revenue  │◄──┤     dim_tenants      │
└──────────────────────┘   └─────────────┬───────────┘   └─────────────────────────┘
                                         │
       ┌─────────────────────────────────┼─────────────────────────────────┐
       ▼                                 ▼                                 ▼
┌──────────────────────┐   ┌─────────────────────────┐   ┌─────────────────────────┐
│     dim_lease_contracts │   │     dim_markets         │   │     dim_date         │
└──────────────────────┘   └─────────────────────────┘   └─────────────────────────┘
```
...
FROM proppulse_dw.fact_lease_revenue f
JOIN proppulse_dw.dim_date dt ON f.date_key = dt.date_key
...
```bash
git clone https://github.com/abdussatarkhan/PropPulse-Commercial-RealEstate-Asset-Analytics.git
cd PropPulse-Commercial-RealEstate-Asset-Analytics
